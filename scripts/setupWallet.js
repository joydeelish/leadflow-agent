...
const MIN_BALANCE_USDC = 1; // minimum USDC to keep in Gateway for payments
...
");
  ...
  if (available < MIN_BALANCE_USDC) {
    console.log(`
Gateway balance low (${available} USDC). Depositing ${MIN_BALANCE_USDC} USDC...`);
...
");
    ...
    console.log(`
✅ Gateway balance sufficient: ${available} USDC`);
